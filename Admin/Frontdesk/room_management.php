    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveRoomForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: 'room_management.php', // Update this to your form processing URL
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(response) {
                        try {
                            ...
                            if (result.success) {
                                ...
                                // Optional: Refresh the room list instead of reloading the page
                                // refreshRoomList();
                            } else {
                                showAlert('danger', result.message || 'Failed to save room. Please try again.');
                            }
                        } catch (e) {
                            console.error('Error parsing response:', e);
                            showAlert('danger', 'Error processing the response. Please try again.');
                        }
                    },
                    error: function(xhr, status, error) {
