...
$create_table_sql = "CREATE TABLE IF NOT EXISTS menu_items_addons (
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <?php else: ?>
                                    <img src="uploads/menus/default.jpg" 
                                         alt="Default" 
                                         style="width: 50px; height: 50px; object-fit: cover;">
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <button class="btn btn-info btn-sm view-addons" 
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div id="imagePreview" class="mt-3" style="display: none;">
                                <img src="" alt="Preview" style="max-width: 100%; max-height: 200px; object-fit: contain;">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <form id="editMenuItemForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Price:</label>
                            <input type="number" class="form-control" name="price" id="edit_item_price" step="0.01" required>
                        </div>
                        <div class="form-group">
                            <label>Current Image:</label>
                            <div id="currentImagePreview" class="mt-2">
                                <img src="" alt="Current" style="max-width: 200px; max-height: 200px; object-fit: contain;">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>New Image (optional):</label>
                            <input type="file" class="form-control" name="item_image" id="editItemImage" accept="image/*">
