...
try {
    ...
    // Check if the selected time is within allowed hours (8:00 AM to 10:00 PM)
    $selectedTime = date('H:i', $selectedTimestamp);
    $startTime = '08:00';
    $endTime = '22:00';

    if ($selectedTime < $startTime || $selectedTime > $endTime) {
        sendResponse(200, 'Events can only be scheduled between 8:00 AM to 10:00 PM.', [
            'status' => 'unavailable',
    ...
    // Check for any overlapping events and get the booked package IDs
