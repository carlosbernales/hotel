                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6 col-sm-4 col-lg-2">
                                <div class="form-group h-100">
                                    ...
                                    <select class="form-select form-select-lg" id="rooms" name="rooms" required>
                            ...
                            <div class="col-6 col-sm-4 col-lg-2">
                                <div class="form-group h-100">
                                    ...
                                    <select class="form-select form-select-lg" id="adults" name="adults" required>
                            ...
                            <div class="col-6 col-sm-4 col-lg-2">
                                <div class="form-group h-100">
                                    ...
                                    <select class="form-select form-select-lg" id="children" name="children">
                            ...
                            <!-- Submit Button -->
                            <div class="col-12 col-sm-6 col-lg-4 mx-auto mt-3">
