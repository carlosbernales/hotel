...
<div class="main-content" id="mainContent">
                            ...
                            <tbody>
                                <?php while ($r = $rooms->fetch_assoc()): ?>
                                    ...
                                    <tr data-booked-room-id="<?= $r['id'] ?>"
                                        data-default-room-type="<?= $bookedRoomTypeId ?>"
    ...
    <div class="modal fade" id="reviewChangesModal" tabindex="-1" aria-labelledby="reviewChangesLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-footer"
                    style="background-color: #f8f9fa; border-top: 2px solid #e0e0e0; padding: 20px;">
