                ...
                <div class="col-md-4">
                    <div class="profile-sidebar">
                        <div class="profile-img-container">
                            <img src="<?php echo isset($fetch_profile['profile_photo']) ? '../../../Admin/adminBackend/user_photo/' . htmlspecialchars($fetch_profile['profile_photo']) : 'images/default-profile.png'; ?>" 
        ...
        .then(data => {
            ...
            if (data.status === 'success') {
                ...
                if (data.profile_photo) {
                    ...
                    if (profileImg) {
                        profileImg.src = `../../../Admin/adminBackend/user_photo/${data.profile_photo}`;
                    }
                }
