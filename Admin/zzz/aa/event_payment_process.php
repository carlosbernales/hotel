...
try {
    ...
    $terms_and_conditions = $stmt->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
    error_log("Error fetching terms and conditions: " . $e->getMessage());
    // Use default terms if database query fails
    $terms_and_conditions = [
        ['title' => 'Booking Confirmation', 'rule_text' => 'Your booking is not confirmed until you receive a confirmation email from us. A 50% down payment is required to secure your booking.'],
        ['title' => 'Payment Terms', 'rule_text' => 'All payments are in Philippine Peso (₱). The balance must be settled at least 7 days before the event date unless otherwise arranged.'],
        ['title' => 'Cancellation Policy', 'rule_text' => 'Cancellations made 30+ days before the event: Full refund of deposit. Cancellations made 15-29 days before the event: 50% refund of deposit. Cancellations made within 14 days of the event: No refund.']
    ];
}
    ...
    <div class="confirmation-container">
        ...
        <div class="confirmation-body">
            ...
            <div class="detail-card">
                ...
                <?php if ($payment_option === 'down_payment'): ?>
                <div class="amount-row">
                ...
                <div class="modal-body">
                    <div class="terms-content mb-4" style="max-height: 400px; overflow-y: auto; padding-right: 15px;">
                        ...
                        <?php if (!empty($terms_and_conditions)): ?>
                            <?php foreach ($terms_and_conditions as $index => $term): ?>
                                <h6 class="mt-4"><?php echo htmlspecialchars($index + 1); ?>. <?php echo htmlspecialchars($term['title']); ?></h6>
    ...
    if (completeBookingBtn) {
        ...
        newCompleteBtn.addEventListener('click', async function() {
            ...
            try {
                ...
                await Swal.fire({
                    title: 'Success!',
                    html: `Your booking has been successfully completed! The booking information has been sent to your email.<br><br>
        ...
        confirmBtn.addEventListener('click', async function() {
            ...
            try {
                ...
                const paymentData = {
                    amount: <?php echo $payment_option === 'full_payment' ? $total_amount : $down_payment; ?>,
                    currency: 'PHP',
