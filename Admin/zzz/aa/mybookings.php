                                    ...
                                    <div class="card-body-custom">
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <?php if($booking['status'] === 'pending'): ?>
                                                <button class="btn btn-danger btn-action" onclick="cancelTableBooking('<?php echo $booking['order_id']; ?>')">
                                    ...
                                    <div class="card-body-custom">
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <?php if($booking['booking_status'] === 'pending'): ?>
                                                <button class="btn btn-danger btn-action" onclick="cancelEventBooking('<?php echo $booking['booking_refId']; ?>')">
                                                    <i class="fas fa-times me-1"></i> Cancel
                                                </button>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <div class="booking-card fade-in">
                                    ...
                                    <div class="card-body-custom">
                                        ...
                                        <div class="countdown-timer mt-2">
                                            ...
                                            <span>Room bookings cannot be cancelled</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function cancelTableBooking(bookingId) {
            Swal.fire({
                ...
                text: 'Are you sure you want to cancel this table reservation?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Cancelled',
                        text: 'Table reservation cancelled successfully',
        ...
        function cancelEventBooking(bookingReference) {
            Swal.fire({
