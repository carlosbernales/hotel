    ...
    <style>
        ...
        * {
        ...
        .menu-card {
            ...
            /* Stacks image and body vertically */
            min-height: 400px;
            /* Set a reasonable minimum height for all cards */
        }
        ...
        .menu-card-body {
            ...
            text-align: center;
            flex-grow: 1;
            /* Allows the body to take up all remaining space in the card */
            display: flex;
            /* Makes the body a flex container */
            flex-direction: column;
            /* Stacks title, price, description, and button */
        }
        ...
        .menu-card-description {
            ...
            max-height: 45px;
            overflow: hidden;
            /* Hides content that exceeds max-height */
            display: -webkit-box;
            -webkit-line-clamp: 2;
            /* Adjust this number to change visible lines (e.g., 3) */
            -webkit-box-orient: vertical;
            margin-bottom: 1rem;
            /* Space before the button */
            color: #6c757d;
            /* Soften the text color for descriptions */
        }
        ...
        .not-available-btn {
            ...
            font-weight: 600;
            margin-top: auto;
            /* Pushes the button to the bottom of the flex container (menu-card-body) */
        }
        ...
        <div class="container">
            ...
            <div class="mobile-icons d-lg-none">
                ...
                <ul class="dropdown-menu dropdown-menu-end notification-dropdown-mobile">
                    ...
                    <li><a class="dropdown-item" href="#"><i class="fas fa-calendar-check me-2 text-info"></i>Room
                            booking confirmed</a></li>
                    <li><a class="dropdown-item" href="#"><i class="fas fa-shopping-bag me-2 text-primary"></i>Order
                            ready for pickup</a></li>
                </ul>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" href="#" id="cafeDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            Café
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="cafeDropdown">
                            <li><a class="dropdown-item" href="#"><i class="fas fa-coffee me-2"></i>Menu & Orders</a>
                            </li>
                            <li><a class="dropdown-item" href="#"><i class="fas fa-chair me-2"></i>Table Reservation</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="desktop-menu d-none d-lg-flex">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="#"><i class="fas fa-user me-2"></i>My Profile</a></li>
                            <li><a class="dropdown-item" href="#"><i class="fas fa-bookmark me-2"></i>My Bookings</a>
                            </li>
                            <li><a class="dropdown-item" href="#"><i class="fas fa-shopping-bag me-2"></i>My Orders</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
