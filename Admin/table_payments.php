...
$query = "SELECT * FROM payments WHERE booking_type = 'table' ORDER BY payment_date DESC";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Table Payments</li>
        </ol>
    </div>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="text-muted">
                                                Reservation Date: <?php echo $payment['booking_date'] ? date('F j, Y', strtotime($payment['booking_date'])) : 'N/A'; ?>
                                            </small>
                                        </td>
                                        <td>
