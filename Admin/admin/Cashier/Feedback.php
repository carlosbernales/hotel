                    ...
                    <form role="form"  data-toggle="validator" method="post" action="ajax.php">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label>Name</label>
                                <input type="text" class="form-control" placeholder="Customer Name" name="compliant_name" required>
                            ...
                            <div class="form-group col-lg-12">
                                <label>Insert Feedback</label>
                                <textarea class="form-control" name="complaint" placeholder="Message" required></textarea>
                            </div>
