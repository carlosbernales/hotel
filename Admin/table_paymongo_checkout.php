...
$checkoutData = [
    'data' => [
        'attributes' => [
            ...
            'success_url' => $input['success_url'] ?? ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/table_payment_process.php?payment=success&ref=' . urlencode($input['reference_number'] ?? 'BOOK-' . uniqid())),
            'cancel_url' => $input['cancel_url'] ?? (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/table.php?payment=cancelled',
            ...
            'line_items' => [
                [
                    ...
                    'name' => $input['description'] ?? 'Table Booking',
                    'quantity' => 1
                ]
            ],
