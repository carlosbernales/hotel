...
// Debug session - uncomment for debugging if needed
    ...
    <div class="container">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <div class="mobile-icons d-lg-none">
                ...
                <!-- Include SweetAlert2 and booking scripts -->
                <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                
                <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
                <script src="js/booking-list.js"></script>
                <script src="js/proceed-booking.js"></script>
                <?php 
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                ...
                <div class="desktop-menu d-none d-lg-flex align-items-center">
                    ...
                    <?php require_once 'room_booking_list.php';?>
                    ...
                    if ($current_page == 'roomss.php'): 
                    ?>
                        <a href="#" class="bed-icon-container" onclick="event.preventDefault(); showBookingList();">
                            <i class="fas fa-bed"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    dropdownElementList.forEach(function(dropdownEl) {
        ...
        dropdownEl.addEventListener('mouseleave', function() {
            // Set a small delay before hiding to allow moving to the dropdown menu
...
function updateNavBadge() {
    ...
    const badges = document.querySelectorAll('.booking-badge, #bookingBadge');
    badges.forEach(badge => {
        if (count > 0) {
