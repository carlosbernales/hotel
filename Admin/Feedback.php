                ...
                <div class="panel-body">
                    ...
                    <div class="filter-container">
                        ...
                        <div class="rating-filter">
                            <button class="btn btn-default rating-filter-btn active" data-rating="all">All
                                Ratings</button>
                        </div>
                        <div class="rating-filter">
                            <button class="btn btn-default rating-filter-btn" data-rating="5"><span
                                    class="star-rating">★★★★★</span></button>
                        </div>
                        <div class="rating-filter">
                            <button class="btn btn-default rating-filter-btn" data-rating="4"><span
                                    class="star-rating">★★★★</span></button>
                        </div>
                        <div class="rating-filter">
                            <button class="btn btn-default rating-filter-btn" data-rating="3"><span
                                    class="star-rating">★★★</span></button>
                        </div>
                        <div class="rating-filter">
                            <button class="btn btn-default rating-filter-btn" data-rating="2"><span
                                    class="star-rating">★★</span></button>
                        </div>
                        <div class="rating-filter">
                            <button class="btn btn-default rating-filter-btn" data-rating="1"><span
                                    class="star-rating">★</span></button>
                        </div>
                    </div>
