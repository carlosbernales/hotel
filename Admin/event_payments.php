...
$query = "SELECT * FROM payments WHERE booking_type = 'event' ORDER BY payment_date DESC";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Event Payments</li>
        </ol>
    </div>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <small class="text-muted">
                                                Event Date: <?php echo $payment['booking_date'] ? date('F j, Y', strtotime($payment['booking_date'])) : 'N/A'; ?>
                                            </small>
                                        </td>
                                        <td>
