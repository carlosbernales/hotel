                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <?php else: ?>
                                    <img src="/Admin/uploads/menus/default.jpg" 
                                         alt="Default" 
                                         style="width: 50px; height: 50px; object-fit: cover;">
            ...
            <div class="modal-content">
                ...
                <form id="editMenuItemForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Description:</label>
                            <textarea class="form-control" name="description" id="edit_item_description" rows="3" placeholder="Enter item description"></textarea>
                        </div>
                        <div class="form-group">
