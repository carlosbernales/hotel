...
if (isset($_GET['packageName'])) {
    $_SESSION['booking_details'] = [
        ...
        'eventPlace' => isset($_GET['event_place']) ? htmlspecialchars($_GET['event_place'], ENT_QUOTES, 'UTF-8') : 'Hall',
    ];
}
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            ...
                                            <strong><?php echo $eventType; ?></strong>
                                        </div>
                                        <?php endif; ?>
                                        <div class="mt-1">
                                            <small class="text-muted">Event Place: </small>
                                            <span class="badge bg-primary"><?php echo $eventPlace; ?></span>
                                        </div>
                ...
                <div class="col-lg-4">
                    <div class="price-details">
                        ...
                        <form id="paymentForm" style="display: none;">
                            ...
                            <input type="hidden" name="metadata[event_place]" value="<?php echo htmlspecialchars($_GET['event_place'] ?? ''); ?>">
