...
$checkoutData = [
    'data' => [
        'attributes' => [
            ...
            'success_url' => $input['success_url'] ?? (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/room_booking_summary.php?payment=success' . 
                (isset($input['metadata']) ? '&' . http_build_query($input['metadata']) : ''),
            'cancel_url' => $input['cancel_url'] ?? (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/room_booking_summary.php?payment=cancelled',
